...
export const SingleArticleView = props => (
  <Fragment>
    ...
    <div className="jumbotron rounded-0">
      ...
      <div className="card-text mt-5">{Parser(String(props.article.body))}</div>
      ...
      <p className="card-text">
        ...
        <span className="pr-2 ml-3">share:</span>
      ...
      {props.authUser.isAuthenticated ? (
        ...
        <Fragment>
          <strong className="text-danger">
            <i className="fa fa-exclamation-triangle" /> You need to login in
            order to like or comment on this article!
          </strong>
        </Fragment>
      )}
